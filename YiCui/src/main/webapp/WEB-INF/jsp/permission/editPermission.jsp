    ...
    <form id="addPermission" class="layui-form form" action="/addPermission.action" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="title" value="${permission.title}"   lay-verify="required" placeholder="请输入权限名称!" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="level" lay-verify="required">
                    <option value=""></option>
                    <option value="1" <c:if test="${permission.level == 1}">selected</c:if>>顶级菜单</option>
                    <option value="2" <c:if test="${permission.level == 2}">selected</c:if>>一级菜单</option>
                    <option value="3" <c:if test="${permission.level == 3}">selected</c:if>>二级菜单</option>
                    <option value="4" <c:if test="${permission.level == 4}">selected</c:if>>三级菜单</option>
                    <option value="5" <c:if test="${permission.level == 5}">selected</c:if>>按钮</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="url"  value="${permission.url}"   lay-verify="required" placeholder="请输入权限!" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">是否展开:</label>
            <div class="layui-input-block">
                <input type="radio" name="spread" value="true" title="展开" <c:if test="${permission.spread =='true'}">checked</c:if> />
                <input type="radio" name="spread" value="false" title="收缩" <c:if test="${permission.spread =='false'}">checked</c:if>/>
            </div>
        </div>
        <!--父级权限名称-->
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text"  value="${pName}" autocomplete="off" class="layui-input">
